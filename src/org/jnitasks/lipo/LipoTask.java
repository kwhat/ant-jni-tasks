...
public class LipoTask extends Task {
	private static final String cmd = "lipo";
	...
	/*
	public LipoTask.Argument createArg() {
	...
	*/
	...
	public void execute() throws BuildException {
		...
		shell.setExecutable(LipoTask.cmd);
		echo.addText(LipoTask.cmd);
